<template>
  <div class="app-container">
    ...
    <el-row :gutter="10">
      ...
      <el-col :md="{ span:4 }">
        <el-radio-group size="mini" v-model="table_config.remoteFilter.by">
...
export default {
  ...
  watch:{
    ...
    "table_config.remoteFilter.select":function(v){
      if(v){
        this.table_config.data = this.table_config.dummy.filter(i=> i[this.table_config.remoteFilter.by].id == v);
      }else{
    ...
    "table_config.remoteFilter.by":function(v){
      ...
      this.table_config.data = this.table_config.dummy;
      if(v!="all"){
        this.table_config.select = this.table_config.dummy[0][this.table_config.remoteFilter.by].id;
      }
    },
  ...
  methods: {
    ...
    getTableFilterOptions(){
      let url = "api/v1/hierarchy_log?list=true&operations=true&date=" + this.table_config.query.date + "&filter_by=" + this.table_config.remoteFilter.by + ".id",
      options = {
        headers:{
