        ...
        >
          <form class="login100-form validate-form">
            <div class="login-container shadow">
              <div
                style="border-left:10px solid crimson;padding:20px;font-weight:900;color:crimson"
              >
                LOGIN FORM
              </div>
              <div
                style="padding-left:20px;padding-right:20px;padding-bottom:50px"
              >
                <el-form
                  ref="loginForm"
                  :model="loginForm"
                ...
                >
                  <div class="form-login">
                    <h1>Howdy!</h1>
                    <small>Please signin to continue.</small>
                  </div>
                  <div class="form-login">
                    ...
                    <div class="form-login-label" style="margin-top:30px;">
                      Password
                    </div>
          ...
          <div
            class="login100-more"
            style="background-image: url('finalbanner.png');"
          >
          <div style="height:100vh;display:flex;justify-content:center">
            <div style="align-self:center">
              <img src="logo-bordered.png" alt="cnm-logo">
            </div>
          </div>
          </div>
        </div>
...
.form-login-button:hover {
  color:white;
  background-color:rgb(255, 47, 89);
}
...
.login100-form {
  ...
  /* background-image: linear-gradient(to bottom right, teal, red); */
