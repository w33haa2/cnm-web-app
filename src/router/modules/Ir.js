...
const IrRouter = {
    ...
    children: [{
            ...
            meta: {
                title: "Receive",
                roles: ["HR Assistant", "Finance Officer", "Team Leader", "Operations Manager", "RTA Supervisor", "RTA Manager", "QA Supervisor", "T & Q Manager", "IT Supervisor"]
            }
        },
        {
            ...
            meta: {
                title: "Issue",
                roles: ["Admin", "HR Manager", "Finance Officer", "Team Leader", "Operations Manager", "RTA Supervisor", "RTA Manager", "QA Supervisor", "T & Q Manager", "IT Supervisor"]
            }
        },
        {
            path: "/incident_reports/all",
            component: () =>
                import ("@/views/incident_reports/all"),
            name: "All",
            meta: {
                title: "All",
                roles: ["Admin", "HR Manager", "HR Assistant"]
        ...
        },
        {
            ...
            component: () =>
                import ("@/views/incident_reports/sanction/index"),
            meta: {
                title: "Sanction",
                roles: ["Admin", "HR Manager", "HR Assistant"]
            },
