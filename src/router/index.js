...
export const asyncRoutes = [{
    ...
    IrRouter,
    {
        ...
        children: [{
            path: "/leave_credits",
            component: () =>
                import ("@/views/leave_credits/index"),
            name: "Leave Credits",
            meta: {
                title: "Leave Credits",
                noCache: false
    ...
    },
    {
        ...
        children: [{
            path: "/work_report",
            component: () =>
                import ("@/views/work_report/index"),
            name: "Work Report",
            meta: {
                title: "Work Report",
                icon: "work-report"
